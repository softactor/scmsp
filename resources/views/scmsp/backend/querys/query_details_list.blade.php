...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Query Details List</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{url('admin/query-details-list')}}">Query Details</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a class="" href="{{ route('admin.query-details-create') }}">
                            <button type="button" class="btn btn-sm btn-success margin-fixing">New
                                Query</button>
                        </a>
                        <?php } ?>
                        <div class="table-responsive">
                            <table
                                class="table data_table table-bordered complain_details_table_style list-table-custom-style"
                                id="complainDetailsdataTable" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th>Code</th>
                                        <th>Priority</th>
