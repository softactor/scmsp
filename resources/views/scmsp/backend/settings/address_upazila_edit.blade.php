                ...
                <div class="row">
                            ...
                            <select class="form-control" name="district_id" id="district_id">
                                ...
                                if (!$districtData->isEmpty()) {
                                    foreach ($districtData as $data) {
                                        ?>
                                        <option value="{{ $data->id }}" <?php if(isset($upazila->district_id) && $upazila->district_id == $data->id){ echo 'selected'; } ?>>
                                            {{ $data->name }}
                                        </option>
                                    <?php 
                                    } // foreach
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="Enter name" name="name" value="<?php echo old('name', $upazila->name); ?>">
                            <?php
                            if ($errors->has('name')) {
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="bn_name" placeholder="Enter Bangla name" name="bn_name" value="<?php echo old('bn_name', $upazila->bn_name); ?>">
                        </div>
                    </div>
                </div>
