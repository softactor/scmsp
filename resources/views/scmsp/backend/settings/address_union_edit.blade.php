                        ...
                        <form action="{{ route('admin.address_union_update') }}" method="post">
                            ...
                            ?>
                                        <select class="form-control" name="district_id" id="district_id"
                                            ...
                                            <option value="<?php echo $districts->id; ?>" selected>
                                                <?php echo $districts->name; ?></option>
                                        </select>
                                        <?php
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="upazila_id" id="upazila_id">
                                            ...
                                            <option value="<?php echo $upazila->id; ?>" selected>
                                                <?php echo $upazila->name; ?></option>
                                        </select>
                                        <?php
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" placeholder="Enter name"
                                            name="name" value="<?php echo old('name', $unionDetails->name); ?>">
                                        <?php
                            if ($errors->has('name')) {
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="bn_name"
                                            ...
                                            value="<?php echo old('bn_name', $unionDetails->bn_name); ?>">
                                    </div>
                                </div>
                            </div>
