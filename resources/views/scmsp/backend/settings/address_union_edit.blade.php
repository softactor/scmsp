...
<div class="container-fluid">
    ...
    <div class='row'>
        <div class='col col-md-12'>
            ...
            <form action="{{ route('admin.address_union_update') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-md-4">
                            ...
                            <select class="form-control" name="division_id" onchange="getAddressDistrictByDivision(this.value,'district_id','<?php echo $getDisByDivUrl; ?>');">
                                ...
                                if (!$divisions->isEmpty()) {
                                    foreach ($divisions as $data) {
                                        ?>
                                        <option value="{{ $data->id }}" <?php if(isset($selectedDivisionId) && $selectedDivisionId == $data->id){ echo 'selected'; } ?>>
                                            {{ $data->name }}
                                        </option>
                                    <?php 
                                    } // foreach
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="upazila_id" id="upazila_id">
                                ...
                                <option value="<?php echo $upazila->id; ?>" selected><?php echo $upazila->name; ?></option>
                            </select>
                            <?php
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="Enter name" name="name" value="<?php echo old('name', $unionDetails->name); ?>">
                            <?php
                            if ($errors->has('name')) {
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="bn_name" placeholder="Enter Bangla name" name="bn_name" value="<?php echo old('bn_name', $unionDetails->bn_name); ?>">
                        </div>
                    </div>
                </div>
                <input type="hidden" name="edit_id" value="<?php echo $unionDetails->id; ?>" />
