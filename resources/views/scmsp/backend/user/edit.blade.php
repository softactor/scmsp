                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                                    <button type="button" class="btn btn-sm btn-primary" onclick="add_more_address_row('<?php echo $more_address_row; ?>')">Add
                                                                        More</button>
                                                                <?php } else { ?>
                                                                    <button type="button" class="btn btn-sm btn-danger" onclick="remove_more_address_row('<?php echo $row_id; ?>')">Remove
                                                                        Address</button>
                                                                <?php } ?>
                                                            </td>
                                                        </tr>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label for="pwd">Area Manager
                                            ...
                                            <span style="color: red;font-style: italic; font-size: 12px; font-weight: bold;">(This
                                                option only be needed when role is service incharge and he/she will
                                                under one Area Manager)</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="all_division" value="1" <?php if (isset($is_all_location) && !empty($is_all_location)) {
                                                                                                            echo 'checked';
                                                                                                        } ?>>
                                                Yes
                                            </label>
