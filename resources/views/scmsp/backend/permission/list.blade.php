...
<div class="container-fluid">
    ...
    <div class='row'>
        <div class='col col-md-12'>
            <h2>Permission List<button type="button" class="btn btn-outline-primary" style="float:right" onclick="window.location.href='{{ route('admin.permission-create') }}'" >Create New</button></h2>
